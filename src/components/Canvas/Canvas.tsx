...
import { RectUtil, RectShape } from "../Rectangle";
...
const shapeUtils: TLShapeUtilsMap<RectShape> = {
  rect: new RectUtil(),
};

const Canvas = observer(function AppInner() {
  const onHoverShape: TLPointerEventHandler = (e) => {
    action(() => pageState.setHoveredId(e.target));
  };
