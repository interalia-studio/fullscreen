    ...
    <div>
      <div className="landingContainer">
        <main className="landing">
          ...
          <VisualPlay src={visualPlay} alt="Web 2.0" />
          ...
          <div>
            ...
            <p>
              ...
              computer, giving you full control over sharing and deleting. You
              can work offline as well as in real-time in a collaborative
              session.
              <br />
            </p>
            <p>
            ...
            <p>
              ...
              the basics for a whiteboard (texts, sticky notes, sections), as
              well as visualisation and facilitation features. Fullscreen is
